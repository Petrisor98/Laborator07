...
public class CalculatorWebServiceAsyncTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        if (operator1 == null || operator1.isEmpty() || operator2 == null || operator2.isEmpty())
            errorMessages = Constants.ERROR_MESSAGE_EMPTY;
        ...
        switch (method) {
            ...
            case Constants.GET_OPERATION:
                ...
                // b) & c) create an instance of a ResultHandler object and execute the request
            ...
            case Constants.POST_OPERATION:
                ...
                pairList.add(new BasicNameValuePair(Constants.OPERATION_ATTRIBUTE, operation));
                pairList.add(new BasicNameValuePair(Constants.OPERATOR1_ATTRIBUTE, operator1));
                pairList.add(new BasicNameValuePair(Constants.OPERATOR2_ATTRIBUTE, operator2));
                ...
                // d) & e) create an instance of a ResultHandler object and execute the request
