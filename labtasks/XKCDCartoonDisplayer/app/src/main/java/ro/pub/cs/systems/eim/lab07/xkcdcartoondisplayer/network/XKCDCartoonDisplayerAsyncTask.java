...
public class XKCDCartoonDisplayerAsyncTask extends AsyncTask<String, Void, XKCDCartoonInformation> {
    ...
    protected void onPostExecute(final XKCDCartoonInformation xkcdCartoonInformation) {
        ...
        if (xkcdCartoonInformation != null) {
            ...
            // based on cartoonUrl fetch the bitmap using Volley and put it into xkcdCartoonImageView

            // previousCartoonUrl -> set the XKCDCartoonUrlButtonClickListener for previousButton
            ...
            // nextCartoonUrl -> set the XKCDCartoonUrlButtonClickListener for nextButton
